...
const renderCountry = function(data, className = '') {
    const html = ` <article class="country ${className}">
              ...
              <div class="country__data">
                ...
                <p class="country__row"><span>\u{1F5E3}\u{FE0F}</span>${Object.values(data.languages)}</p>
                <p class="country__row"><span>\u{1F4B0}</span>${Object.values(data.currencies)[0].name}</p>
